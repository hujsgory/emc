...
static char _smn_any_doc[]="Upper part of a matrix S calculation";

static PyObject * _smn_any_cond(PyObject * self, PyObject * args){
    npy_bool iflg=1;
    npy_int offset=0;
    PyObject  *py_list1=NULL, *py_list2=NULL;
    PyArrayObject *block_S=NULL;
    PyArg_ParseTuple(args,"OOOib", &block_S, &py_list1, &py_list2, &offset, &iflg);
...
static PyObject * _smn_any_diel(PyObject * self, PyObject * args){
    npy_bool iflg=1;
    npy_int offset;
    PyObject  *py_list1=NULL, *py_list2=NULL;
    PyArrayObject *block_S=NULL;
...
static PyMethodDef _methods[]={{"any_cond", _smn_any_cond, METH_VARARGS, _smn_any_doc},
                               {"any_diel", _smn_any_diel, METH_VARARGS, _smn_any_doc},
